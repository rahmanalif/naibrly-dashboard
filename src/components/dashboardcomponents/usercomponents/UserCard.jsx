    ...
    return (
        <div className=" p-4 border shrink-0 rounded-lg shadow-md bg-white">
            <div className="flex items-center bg-[#1C59410D]/50 p-5 rounded-lg">
                ...
                <div className="ml-4 flex flex-col gap-3">
                    ...
                    <div className="flex items-center text-sm text-gray-500">
                        <span className="border border-[#3EBF5A] py-1 px-3 rounded-sm">User</span>
                    </div>
          ...
          <Button variant="outline" color="red">Ban</Button>
            ...
            <div className="mt-4">
                <hr />
                <h3 className="text-md font-semibold my-4">Details</h3>
                <hr />
            ...
            <div className="ml-auto flex gap-2 justify-center my-5">
                <Button variant="outline" className="border bg-[#4FB2F3] text-white" color="green">Chat</Button>
                <Button variant="outline" className="bg-[#F34F4F] text-white hover:bg-[#F34F4F] hover:text-white" color="red">Ban</Button>
            </div>
        </div>
    );
